...
@bot.message_handler(func=lambda message: (groups[str(message.chat.id)].game_in_process) if (message.chat.type == "group" or message.chat.type == "supergroup") else False)
